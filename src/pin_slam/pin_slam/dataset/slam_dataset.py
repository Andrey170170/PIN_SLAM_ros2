...
from pin_slam.dataset.dataloaders import dataset_factory
from pin_slam.eval.eval_traj_utils import absolute_error, plot_trajectories, relative_error
from pin_slam.utils.config import Config
from pin_slam.utils.semantic_kitti_utils import sem_kitti_color_map, sem_map_function
...
class SLAMDataset(Dataset):
    ...
    def read_frame_ros(self, msg):
        ...
        from pin_slam.utils import point_cloud2
